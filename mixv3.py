...
for linenum in range (0,len(lines)):
    if lines[linenum+2].find("Z0.4")==-1:
        ...
        break
# arrayXYE = lines[linenum-3].split()
stringreplace=""
eValue21=eValue11
eValue12 = eValue21
eValue22 = eValue21
...
while(1):
    ...
    # if (height*layer>maxz-10): print ("-----------------",height*layer)
    ...
    while lines2[linenum2].find(txt1)==-1:
        ...
        linenum2+=1
    # Retract before 0.1mm outer
    if (lines2[linenum2-2].find("E")!=-1 and lines2[linenum2-2][0]=="G"):
        stringreplace = lines2[linenum2-2][0:lines2[linenum2-2].find(" E")+2:1]
    ...
    while lines2[linenum2].find(txt2)==-1:
    ...
    while lines[linenum].find(txt4)==-1 :
        if lines[linenum].find("M106")!=-1:
            linenum+=1
            continue
    ...
    eValueold=eValue12
    # linenum+=2
#     # print("f23",linenum,eValue11,eValue12,eValue21,eValue22,eValueold)
    if (height*layer<=maxz): 
        ...
        indexw = len(arrayXYE)-1
        eValue21= float(arrayXYE[indexw][1:len(arrayXYE[indexw]):1])
        while lines2[linenum2+2].find(txt3)==-1:
            if lines2[linenum2].find("LAYER")>-1 or lines2[linenum2].find("TIME")>-1 or lines2[linenum2].find(" Z")>-1 :
                linenum2+=1
                continue
            if (lines2[linenum2].find("E")!=-1 and lines2[linenum2][0]=="G"):
                arrayXYE = lines2[linenum2].split()
                ...
                eValue22 = float(arrayXYE[indexx][1:len(arrayXYE[indexx]):1])
                eValue23=eValue22
                # print("a",linenum2,eValue11,eValue12,eValue21,eValue22,eValueold)
                eValue22=round(eValue22-eValue21+eValueold,5)
                # print (eValue22)
                stringreplace = lines2[linenum2][0:lines2[linenum2].find(" E")+2:1]
